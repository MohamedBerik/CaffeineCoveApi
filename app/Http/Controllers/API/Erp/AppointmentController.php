...
class AppointmentController extends Controller
{
    ...
    //                 ], 422);
    //             } catch (\Exception $e) {
    //                 // جلب الخطأ من داخل الـ transaction
    //                 Log::error('Transaction Error in complete: ' . $e->getMessage());
    ...
    //         });
    //     } catch (\Exception $e) {
    //         // جلب الخطأ من خارج الـ transaction
    //         Log::error('Outer Error in complete: ' . $e->getMessage());
    //         Log::error($e->getTraceAsString());
