                            ...
                            <div class="col-lg-8">
                                <div class="header-text">
                                    ...
                                    <p>Mexant HTML5 Template is provided for free of charge. This layout is based on
                                        Boostrap 5 CSS framework. Anyone can download and edit for any professional website.
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="header-text">
                                    ...
                                    <div class="div-dec"></div>
                                    <p>When you browse through different tags on TemplateMo website, you can see a variety
                                        of CSS templates which are responsive website designs for different individual
                                        needs. Please tell your friends about our website. Thank you.</p>
                                    <div class="buttons">
                                        <div class="green-button">
                                            <a href="#">Discover More</a>
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="service-item">
                        ...
                        <p>Templates are based on Bootstrap 5 CSS framework. You can easily adapt or modify based on your
                            needs.</p>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="left-image">
                        <img src={{ asset('assets/images/calculator-image.png') }} alt="">
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="section-heading">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="owl-testimonials owl-carousel" style="position: relative; z-index: 5;">
                        <div class="item">
                            ...
                            <p>“Donec et nunc massa. Nullam non felis dignissim, dapibus turpis semper, vulputate lorem. Nam
                                volutpat posuere tellus, in porttitor justo interdum nec. Aenean in dapibus risus, in
                                euismod ligula. Aliquam vel scelerisque elit.”</p>
                            <h4>David Eigenberg</h4>
                            <span>CEO of Mexant</span>
                            <div class="right-image">
                                <img src={{ asset('assets/images/testimonials-01.jpg') }} alt="">
                            </div>
                        </div>
                        <div class="item">
                            <i class="fa fa-quote-left"></i>
